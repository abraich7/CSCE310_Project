...
<!-- Student Program Progress Functionality: Delete
...
<html lang="en">
    <head>
        ...
        <title> Student Program Progress: Delete </title>
    </head>
    <body>
        <div> 
            <h1> Delete a Progress Record  </h1>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <label for = "PK"> Enter the unique number associated with your record that you want to delete (primary key): </label><br>
