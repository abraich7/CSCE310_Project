...
<!-- Admin Program Progress Functionality: Update
...
<html lang="en">
    <head>
        ...
        <title> Program Progress: Update </title>
    </head>
    <body>
        <div> 
            <h1> Update a Student's Progress Records  </h1>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <label for = "PK"> Enter the unique number associated with record you want to update (primary key): </label><br>
            ...
            <?php
                ...
                { 
                    ...
                    else if ($Program == 'Certification')
                    {
                        ...
                        if($Stat_update == 'Certified')
                        {
                            $sql = "UPDATE cert_enrollment SET Training_Status = '$Stat_update' WHERE CertE_Num = '$CertE_num'";
                        }
